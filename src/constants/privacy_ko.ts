...
export const privacyTerm = {
  ...
  <body>
    ...
    <div class="section">
      <h2>제1조(목적)</h2>
      <p>
        단비랩스(DanbiLabs)(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사
    ...
    <div class="section">
      ...
      <ul>
        <li>필수 수집 정보: 이메일 주소 및 닉네임</li>
        <li>선택 수집 정보: 프로필 이미지, 연령, 성별</li>
      </ul>
    </div>
    ...
    <div class="section">
      ...
      <ol>
        ...
        <li>
          회사는 전항의 경우에 개인정보의 정정을 완료하기 전까지 개인정보를 이용
          또는 제공하지 않으며 잘못된 개인정보를 제3자에게 이미 제공한 경우에는
    ...
    <div class="section">
      ...
      <ol>
        ...
        <li>
          회사는 만일의 사태에 대비하여 침입차단 시스템을 이용하여 보안에 최선을
          다하고 있습니다.
        </li>
        <li>
          회사는 민감한 개인정보를 암호화 통신 등을 통하여 네트워크상에서
    ...
    <div class="section">
      <h2>제23조(개인정보 유출 등에 대한 조치의 예외)</h2>
      <p>
    ...
    <div class="section">
      <h2>제25조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h2>
      <ol>
        <li>
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            <li>성명: 심단비</li>
            <li>직책: CEO</li>
            <li>전화번호: 01031070596</li>
            <li>이메일: colleksql3@gmail.com</li>
          </ul>
        </li>
      </ol>
    </div>
    ...
    <div class="section addendum">
      <h2>부칙</h2>
      <div class="section">
        <h2>제1조</h2>
        <p>본 방침은 2025.08.01.부터 시행됩니다.</p>
      </div>
    </div>
  </body>
  `,
